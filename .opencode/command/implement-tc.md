...
Цикл реализации включает: реализацию отсутствующих AA-зависимостей (`actions/AA-<CODE>.ts`), создание или обновление JSON-спецификации селекторов для TC и его Action (`document_authoring.py write-selectors`), затем реализацию самого TC — подробно в `test-development.md`, раздел «5. Реализация».
