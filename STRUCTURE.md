...
- `docs/actions/`, `docs/test-cases/` — утверждённые спецификации Action и TC с их JSON-спецификациями селекторов (`<ID>.selectors.json`). Расположение может отличаться — см. «Контекст проекта» в `AGENTS.md`.
